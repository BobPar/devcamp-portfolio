module ApplicationHelper
  ...
  def source_helper(styles)
    if session[:source]
      greeting = "Thank you for visiting from #{session[:source]}, pls feel free to #{ link_to "contact me", contact_path }if you like to work together." 
      content_tag(:div, greeting.html_safe, class: styles)
    end
  end

  def copyright_generator
    DevcampViewTool::Renderer.copyright 'K Sugada', 'All rights reserved'
  end
